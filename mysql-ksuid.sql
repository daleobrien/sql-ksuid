DELIMITER //
CREATE FUNCTION generate_ksuid() RETURNS VARCHAR(27) NOT DETERMINISTIC
BEGIN
    DECLARE digits CHAR(62) DEFAULT "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
    
    DECLARE n DECIMAL(49) DEFAULT UNIX_TIMESTAMP() - 1393938000; -- 8 byte time portion offset per specification.
    DECLARE f DECIMAL(49) DEFAULT 4294967296;
    DECLARE s VARCHAR(27) DEFAULT "";
